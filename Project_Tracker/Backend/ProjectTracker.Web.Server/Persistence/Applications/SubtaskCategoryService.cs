...
public class SubtaskCategoryService(ISubtaskCategoryRepository repo, IProjectTrackerUnitOfWork uow) : ISubtaskCategoryService
{
    ...
    private static SubtaskCategoryDto ToDto(SubtaskCategoryEntity e) => new() { Id = e.Id, Name = e.Name, SubtaskId = e.SubtaskId };
    private static SubtaskCategoryEntity ToEntity(SubtaskCategoryDto d) => new() { Name = d.Name, SubtaskId = d.SubtaskId };
}
