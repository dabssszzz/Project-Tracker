...
export function Sidebar({ isCollapsed, onToggleCollapse }: { isCollapsed: boolean, onToggleCollapse: () => void }) {
  ...
  const SidebarContent = ({ collapsed }: { collapsed: boolean }) => (
    <div className="flex flex-col h-full">
      {/* Top Section - Logo removed as it's in TopNav */}
      <div className="py-2" />

      {/* Menu Items */}
      <div className="flex-1 overflow-y-auto pt-16 pb-4 px-3">
            ...
            const menuItem = (
              <NavLink
                ...
                className={({ isActive }) => cn(
                  ...
                  isActive
                    ? 'bg-red-50 text-gray-900 border-l-4 border-[#E10600]'
              ...
              >
                <Icon
                  className={cn(
                    ...
                    'group-data-[active=true]:text-[#E10600] text-gray-500 group-hover:text-gray-700'
                  )}
                />
                {!collapsed && (
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="absolute -right-3 top-24 w-6 h-6 bg-white border border-gray-200 rounded-full flex items-center justify-center hover:bg-gray-50 transition-colors shadow-sm z-50"
