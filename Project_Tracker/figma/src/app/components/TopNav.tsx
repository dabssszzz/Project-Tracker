...
export function TopNav({ onGoToAnalytics }: TopNavProps) {
  return (
      ...
      <div className="px-4 sm:px-6 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            ...
            <Button
              className="text-white hover:opacity-90 transition-all hover:shadow-lg text-sm sm:text-base px-3 sm:px-4 h-8 sm:h-10"
